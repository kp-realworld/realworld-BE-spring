...
//        // 태그1, 태그2 string list
//        List<String> tagList = List.of("태그1", "태그2");
//        // given
...
//        final AddArticleRequest request = new AddArticleRequest("제목", "설명", "내용", tagList, new User(50L));
//
...
//                .build());
//
//        List<String> tagList2 = List.of("수정된 태그1", "수정된 태그2");
//        AddArticleRequest updateRequest = new AddArticleRequest("수정된 제목22", "수정된 설명", "수정된 내용",tagList2, new User(50L));
//
